...
class _TrimVideoScreenState extends State<TrimVideoScreen> {
  ...
  Future<void> share(String path) async {
    // final result = await Share.shareXFiles([path], text: 'Great picture');
        ...
        backWidget: CloseButton(
          onPressed: () {
            showConfirmDialogCustom(context,
                title: 'You trim video will be lost',
                primaryColor: colorPrimary,
                positiveText: 'Ok',
                negativeText: 'Cancel', onAccept: (context) {
              finish(context);
            });
          },
        ),
        ...
        children: <Widget>[
          ...
          TrimViewer(
            ...
            editorProperties: TrimEditorProperties(
                borderPaintColor: colorPrimary, circlePaintColor: colorPrimary),
            onChangeStart: (value) {
              startValue = value;
            },
            onChangeEnd: (value) {
