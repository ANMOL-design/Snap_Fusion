...
class PhotoEditScreenState extends State<PhotoEditScreen> {
  ...
  Future<void> onTextTemplet() async {
    ...
    String? textTamplet = await showModalBottomSheet(
        context: context,
        backgroundColor: Colors.transparent,
        builder: (_) => TextTemplatePickerBottomSheet());
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(mIsText ? 'Done' : 'Save',
                              ...
                              .withShaderMaskGradient(LinearGradient(
                        ...
                        children: [
                          ListView(
                            ...
                            children: [
                              ...
                              BottomBarItemWidget(
                                  title: 'Emoji',
                                  icons: Icon(FontAwesomeIcons.faceSmile).icon,
                                  onTap: () => onEmojiClick()),
                              BottomBarItemWidget(
                                  title: 'Stickers',
                                  icons:
                                      Icon(FontAwesomeIcons.faceSmileWink).icon,
                                  onTap: () {
                                    setState(() {
                                      onStickerClick();
                                    });
                              ...
                              BottomBarItemWidget(
                                  title: 'Pen',
                                  icons: Icon(FontAwesomeIcons.penFancy).icon,
                                  onTap: () => onPenClick()),
                              BottomBarItemWidget(
                                  title: 'Brightness',
                              ...
                              BottomBarItemWidget(
                                  ...
                                  icons: Icon(Icons.format_shapes_sharp).icon,
                                  onTap: () => onTextTemplet()),
                              BottomBarItemWidget(
                                  title: 'Border',
                                  icons: Icon(Icons.format_shapes_sharp).icon,
