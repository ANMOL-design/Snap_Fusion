...
class LastEditedPictureScreenState extends State<LastEditedPictureScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Last saved pictures',
              style: boldTextStyle(
                  color: Colors.white,
                  size: 20,
                  letterSpacing: 0.3,
          ...
          leading:
              Icon(Icons.arrow_back, color: Colors.white, size: 24).onTap(() {
            finish(context, true);
          }),
            ...
            IconButton(
              ...
              onPressed: () {
                showConfirmDialogCustom(context,
                    ...
                    title: 'Do you want to delete all saved pictures?',
                    onAccept: (context) {
          ...
          child: Stack(
            ...
            children: [
              SingleChildScrollView(
                  ...
                  child: LastEditedListWidget(isDashboard: false)),
