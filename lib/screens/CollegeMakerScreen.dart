...
class CollegeMakerScreenState extends State<CollegeMakerScreen> {
  ...
  gotoHomeDialog() {
    showConfirmDialogCustom(context,
        ...
        positiveText: 'Ok',
        negativeText: 'Cancel', onAccept: (context) async {
  ...
  Widget borderWidget(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Border width', style: boldTextStyle())
              .paddingOnly(left: 16, top: 8, right: 16, bottom: 16),
          Slider(
            value: borderWidth,
            min: minWidth,
            max: maxWidth,
  ...
  Widget radiusWidget(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Border radius', style: boldTextStyle())
              .paddingOnly(left: 16, top: 8, right: 16, bottom: 16),
          Slider(
            value: borderRadius,
            min: minBorderRadius,
  ...
  Widget spacingWidget(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Spacing', style: boldTextStyle())
              .paddingOnly(left: 16, top: 8, right: 16, bottom: 16),
          Slider(
            value: imageSpacing,
            min: minSpacing,
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar:
            appBarComponent(context: context, title: 'Collage Maker', list: [
          TextButton(
            onPressed: () {
              ...
              Screenshot(
                ...
                child: widget.isAutomatic!
                    ? CollegeMakerLayoutWidget(
                        columnCountList:
                            getCollegeMakerList()[collegeItemIndex].listCount![
                                Random().nextInt(
                                    getCollegeMakerList()[collegeItemIndex]
                                        .listCount!
                                        .length)],
                        ...
                        children: [
                          Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: getCollegeMakerList()[collegeItemIndex]
                                  .listCount!
                                  .length,
